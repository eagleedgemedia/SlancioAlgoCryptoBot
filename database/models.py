...
class User(Base):
    ...
    stop_loss_points: Mapped[float] = mapped_column(Float, default=600.0)
    ...
    ema_distance_points: Mapped[int] = mapped_column(Integer, default=400)   # Entry condition: points above EMA 7 Low
